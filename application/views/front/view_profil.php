...
<body >
            ...
            <nav role="navigation" class="">
                <div class="nav-wrapper container">
                    ...
                    <ul id="id-nav" class="hide-on-med-and-down">
                        ...
                        <li><a href="#offre" class="links">Mes offres</a></li>
                        <li><a href="#demande" class="links">Mes demandes</a></li>
    ...
    <div id="Contents">
        ...
        <section id="offre">
            <div class="container">
                <div class="row">
                    <h2>Mes Offres&nbsp;<a href=""><i class="small material-icons">add</i></a></h2>
                    <div class="row">
        ...
        <section id="demande">
            <div class="container">
                <div class="row">
                    <h2>Mes Demandes&nbsp;<a href=""><i class="small material-icons">add</i></a></h2>
    ...
    <!-- <div id="footer">
        <footer class="page-footer">
            <div class="container">
                <div class="row">
                    <div>
                        <p>© 2018 Développé par Pringue Gillardeaux Marchal - Tout droit réservé
